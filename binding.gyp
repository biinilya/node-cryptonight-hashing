    ...
    "targets": [
        {
            ...
            "cflags_c": [
                '<!@(uname -a | grep "aarch64" >/dev/null && echo "-march=armv8-a+crypto+fp+simd -flax-vector-conversions -DXMRIG_ARMv8" || (uname -a | grep "armv7" >/dev/null && echo "-mfpu=neon -flax-vector-conversions -DXMRIG_ARM=1" || echo "-march=native -DXMRIG_FEATURE_ASM"))',
